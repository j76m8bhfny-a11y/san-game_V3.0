...
export const MessageWindow: React.FC<MessageWindowProps> = React.memo(({ event }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative flex items-center justify-center" style={{ width: '66.67vw', maxWidth: '800px', height: '60vh' }}>
          <img 
            src={eventImg} 
            alt="Event Scene" 
            className="max-w-full max-h-full object-contain render-pixelated rounded-lg"
            style={{ 
