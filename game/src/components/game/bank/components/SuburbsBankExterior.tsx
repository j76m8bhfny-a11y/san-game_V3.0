  ...
  return (
    <div className="relative w-full h-full flex flex-col justify-between p-8 overflow-hidden select-none font-pixel">
      ...
      >
        {/* 屏幕发光效果 */}
        <div className={`
          absolute top-10 left-10 w-40 h-32 bg-blue-400/30 blur-xl rounded-sm
        ...
        {/* 交互提示 */}
        <div className={`
          absolute -top-12 left-1/2 -translate-x-1/2 bg-white/90 text-blue-900 px-4 py-1 rounded-sm text-xs font-bold shadow-pixel
        ...
        {/* 全息覆盖层 (装饰) */}
        <div className="absolute inset-0 border-2 border-transparent group-hover:border-blue-400/50 rounded-sm transition-colors" />
      </div>

      {/* 3. 银行 Logo */}
      <div className="absolute top-10 left-10 bg-white/90 p-3 rounded shadow-pixel flex items-center gap-3">
