      ...
      <div className="absolute top-2 left-2 right-2 bottom-2 bg-white shadow-inner p-3 font-serif text-gray-800 flex flex-col z-10">
        ...
        <div className="flex-1 space-y-1 text-[10px]">
          <div className="flex justify-between">
            ...
            <span className="font-mono font-bold">${product.amount}</span>
          </div>
          <div className="flex justify-between">
            <span>Interest Rate:</span>
            <span className="font-mono text-red-700">{(product.interestRate * 100).toFixed(1)}%</span>
          </div>
          <div className="flex justify-between">
            <span>Term:</span>
            <span className="font-mono">{product.termDays} Days</span>
          </div>
