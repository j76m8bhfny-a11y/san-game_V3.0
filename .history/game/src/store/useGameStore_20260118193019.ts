...
interface GameActions {
  ...
  setViewingArchive: (archiveId: string | null) => void; // [修复] 移动到这里，去重
  ...
  persist(
    (set, get) => ({
      ...
      chooseOption: (optionId) => {
        ...
        const P = calcPressure(state.san);     // [修复] 此函数现已正确导入
