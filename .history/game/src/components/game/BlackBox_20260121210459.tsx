          ...
          >
            ...
            <div className="w-full md:w-[55%] p-8 md:p-12 overflow-y-auto custom-scrollbar relative z-10 border-r border-[#d4c5a9]">
              ...
              <div className="font-serif text-lg leading-relaxed text-justify space-y-6">
                <p className="first-letter:text-5xl first-letter:font-bold first-letter:float-left first-letter:mr-3 first-letter:mt-[-10px] font-medium">
                  {currentDoc.flavorText}
                </p>
                <p className="opacity-80">
                  Following the incident, visual confirmation was acquired. The subject appears to demonstrate characteristics inconsistent with standard biological classification...
                </p>
                {/* 装饰性的涂改块 */}
                <p className="bg-black/90 text-transparent select-none w-3/4 transform rotate-[0.5deg]">
                  THIS SECTION HAS BEEN REDACTED BY ORDER OF THE COUNCIL.
                </p>
              </div>
