...
import { Insurance, LoanProduct, PlayerClass } from '@/types/schema';
...
export const BankSidebar: React.FC = () => {
  ...
  // 获取数据
  const loans = gameDataCache?.loans || [];
              ...
              <div className="relative z-10">
                ...
                {activeInsurance ? (
                  <div className="text-sm text-gray-300">
                    <span className="text-emerald-400 font-bold">已生效</span> • 每周扣费 ${activeInsurance.weeklyCost}
                  </div>
                ) : (
