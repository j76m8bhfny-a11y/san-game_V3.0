  ...
  return (
    <div className="relative w-full h-full flex flex-col justify-between p-8 overflow-hidden select-none font-sans">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: "url('/assets/faith/suburbs_church_exterior.jpg')",
      ...
      {/* 2. 巨型 LED 屏幕 (动态内容) */}
      <div className="absolute top-[20%] left-1/2 -translate-x-1/2 w-[40%] h-[25%] transform -skew-x-12 opacity-90 overflow-hidden shadow-2xl border-4 border-gray-800 bg-black">
        {/* 屏幕内容循环 */}
        ...
        {/* 扫描线效果 */}
        <div className="absolute inset-0 bg-[url('/assets/fx/scanlines.png')] opacity-20 pointer-events-none" />
      </div>

      {/* 3. 品牌 Logo */}
      <div className="relative z-10 mt-4 ml-8">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 bg-blue-600 rounded-lg flex items-center justify-center text-white text-2xl font-bold shadow-lg">
            G
          </div>
      ...
      >
        <div className={`
          relative px-8 py-3 bg-white/90 backdrop-blur-md rounded-full shadow-2xl
