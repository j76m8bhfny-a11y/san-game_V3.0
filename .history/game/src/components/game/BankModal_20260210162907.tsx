...
// import { SuburbsBank } from './bank/SuburbsBank'; // 如果你已经创建了这些组件
// import { DowntownBank } from './bank/DowntownBank'; // 如果你已经创建了这些组件
