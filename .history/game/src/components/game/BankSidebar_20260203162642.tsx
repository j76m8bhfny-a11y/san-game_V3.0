...
export const BankSidebar: React.FC = () => {
  ...
  const handleSignInsurance = (plan: Insurance) => {
    ...
    const newInsurance: ActiveInsuranceState = {
      ...
      renewalTurn: currentTurn + 12 
    };

    setInsurance(newInsurance);
    addNotification(`已签约: ${plan.name}`, "success");
  };
  ...
  // ✅ 修复 5: 移除未使用的 totalDue 变量 (Line 234 warning)
  // const totalDue = ... (已删除)

  return (
    <div className="h-full flex flex-col bg-[#0a0a0a] text-white font-mono border-l border-gray-800">
      {/* Header Tabs */}
              ...
              {activeInsurance ? (
                <div>
                  ...
                  <div className="text-xs text-emerald-300/70 mt-1">
                    续费周期: {activeInsurance.renewalTurn - currentTurn} 周后
                  </div>
