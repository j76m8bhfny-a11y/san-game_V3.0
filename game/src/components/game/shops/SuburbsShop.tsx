  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-solid-dark" onClick={onClose}>
      ...
      <div 
        ...
        className="relative w-full max-w-6xl aspect-video bg-[#f8fafc] shadow-pixel overflow-hidden border-8 border-white rounded-sm flex flex-col"
        style={{
      ...
      >
        ...
        {/* --- 顶部：品牌与欢迎语 --- */}
        <div className="h-28 backdrop-solid-light z-20 flex justify-between items-center px-10 shadow-sm border-b border-green-100">
          ...
          {/* 电子会员卡风格的余额显示 */}
          <div className="bg-green-700 text-white px-6 py-3 rounded-sm shadow-pixel-sm flex items-center gap-4 transform hover:scale-105 transition-transform">
             ...
             <div className="h-8 w-8 bg-white/20 rounded-sm flex items-center justify-center text-lg">💳</div>
          </div>
        </div>
        ...
        <div className="h-24 bg-[#e2e8f0] border-t-4 border-[#cbd5e1] flex items-center justify-between px-10 relative z-20">
           ...
           <button 
             onClick={onClose}
             className="relative z-10 px-8 py-3 bg-white hover:bg-red-50 text-gray-700 hover:text-red-600 border border-gray-300 hover:border-red-300 rounded-sm font-pixel font-bold transition-all shadow-sm"
           >
