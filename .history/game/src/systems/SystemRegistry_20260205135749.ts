...
const activeSystems: GameSystem[] = [
  { ...HousingSystem, priority: priorities.housing },
  { ...BankSystem, priority: priorities.bank },
  { ...JobSystem, priority: priorities.job },
  { ...BillSystem, priority: priorities.bill }, // 替换 70
  { ...FaithSystem, priority: priorities.faith },
  { ...EventSystem, priority: NARRATIVE_RULES.system.priority }
